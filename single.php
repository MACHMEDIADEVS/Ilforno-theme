...
<style>
    ...
    /* CAMBIO DE COLOR PARA ENLACES Y REDES SOCIALES */
    .single-blog-page .text-golden {
        color: #dacfbd !important;
    }

    .single-blog-page .widget-categories ul li a {
        color: #dacfbd;
    }

    .single-blog-page .text-golden:hover,
    .single-blog-page .widget-categories ul li a:hover {
        color: #ffffff;
    }



    /* IMÁGENES EN ARTÍCULOS RECIENTES */
                        ...
                        <aside id="secondary" class="widget-area">
                            <div class="bg-dark p-4 widget widget-social">
                                ...
                                <div class="social-links-grid d-flex gap-3">
                                    <a href="https://www.facebook.com/ilfornolegna" class="text-golden"><i class="bi bi-facebook fs-4"></i></a>
                                    <a href="https://www.instagram.com/ilfornolegna/" class="text-golden"><i class="bi bi-instagram fs-4"></i></a>
                                    <a href="https://www.tiktok.com/@ilfornolegna" class="text-golden"><i class="bi bi-tiktok fs-4"></i></a>
                                </div>
                            </div>
