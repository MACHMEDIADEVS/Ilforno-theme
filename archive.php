<style>
   ...
   ========================================================================== */
    ...
    .archive .post-card-home-style .card-title a {
        color: #1a1a1a;
        /* Texto oscuro para el título */
        font-weight: bold;
    }

    .archive .post-card-home-style .card-text {
        color: #333;
        /* Texto un poco más claro para la descripción */
    }
   ...
   ========================================================================== */
    ...
    .hero-archive-section .container {
        position: relative;
        /* Para que el texto esté sobre la superposición */
    }
</style>
...
<main id="primary" class="site-main py-5" style="background-color: #181616ff;">
    <div class="container">
