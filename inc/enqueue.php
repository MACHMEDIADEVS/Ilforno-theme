...
function il_forno_a_legna_scripts()
{
	...
	*/
	...
	wp_enqueue_style('bootstrap-icons', 'https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css', array(), '1.11.3', 'all');

	// Swiper CSS from CDN
	wp_enqueue_style('swiper-css', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css', array(), '11.0.5', 'all');

	// Main theme stylesheet (style.css)
	wp_enqueue_style('il-forno-a-legna-style', get_stylesheet_uri(), array(), $theme_version);

	// Custom main stylesheet (css/main.css)
	...
	// Custom responsive stylesheet (css/responsive.css)
